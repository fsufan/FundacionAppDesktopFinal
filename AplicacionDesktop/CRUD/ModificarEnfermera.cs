...
{
    public partial class ModificarEnfermera : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
                ...
                if (txtRut.Text != "")
                {
                    ...
                    if (seguridad.validarRut(txtRut.Text))
                    {
                        ...
                        if (AuxInfo.consultarRut(txtRut.Text) == true)
                        {
                            ...
                            txtTurno.Text = enfermera.Turno;
                            txtEspecialidad.Text = enfermera.Especialidad;
                            txtDescripcion.Text = enfermera.Descripcion;
                            DateFechIngreso.Value = enfermera.FechaIngreso;
                            lblidUsuario.Text = enfermera.Id_usuario.ToString();
                            lblenfermera.Text = enfermera.Id_enfermera.ToString();
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("El rut No pertenece a al de una Enfermera");
            }
        ...
        {
            MenuAdminEnfermera ME = new MenuAdminEnfermera();
            ME.Show();
            this.Hide();
        }
                        ...
                        if (seguridad.validarRut(txtRut.Text))
                        {
                            if (DateTime.Compare(DateTime.Today, DateFechaNac.Value.Date) > 0)
                            {
                                    ...
                                    if (ComprobarFormatoEmail(txtEmail.Text) == true)
                                    {
                                        ...
                                        {
                                            DialogResult dialogResult = MessageBox.Show("Desea Modificar la Enfermera de nombre : " + txtNombre.Text + " " + txtApePaterno.Text, "Informacion", MessageBoxButtons.YesNo);
                                            if (dialogResult == DialogResult.Yes)
                                            {
                                                DialogResult resultado = MessageBox.Show("Se modificara la Enfermera ¿Desea Continuar?", "Atencion", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
                                                switch (resultado)
                                                {
                                                        ...
                                                        if (auxDireccion.actualizarDireccion(direccion) > 0)
                                                        {
                                                            ...
                                                            if (auxInfoPersonal.ActualizarInfoPersonal(infoPersonal) > 0)
                                                            {
                                                               ...
                                                               // usuario.Contrasena = txtContraseña.Text.ToUpper().Trim();
                                                                    ...
                                                                    enfermera.Id_enfermera = int.Parse(lblenfermera.Text);
                                                                    ...
                                                                    enfermera.Id_infopersonal = int.Parse(lblidinfo.Text);
                                                                    enfermera.Id_usuario = int.Parse(lblidUsuario.Text);

                                                                    if (auxEnfermera.ActualizarEnfermera(enfermera) > 0)
                                                                    {
                                                                        ...
                                                                        lblenfermera.Text = string.Empty;
                                                                        ...
                                                                        MessageBox.Show("Enfermera Modificada ");
                                                                    }
                                                                    else
                                                                    {
                                                                        MessageBox.Show("Error al modificar una Enfermera");
                                                                    }
